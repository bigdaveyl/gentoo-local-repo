...
src_configure() {
	...
	use petsc && \
		mycmakeargs+=(
		-DPETSC_LIBRARY_DIRS="${EPREFIX}/usr/lib64/petsc/lib;${EPREFIX}/usr/lib/petsc/lib"
		-DPETSC_INCLUDE_DIRS="${EPREFIX}/usr/lib64/petsc/include;${EPREFIX}/usr/lib/petsc/include"
	)
