...
IUSE="${MYTHPLUGINS} alsa cdda cdr exif flac +hls ieee1394 libass musicbrainz raw +theora +vorbis +xml xvid"
...
RDEPEND="
	...
	=media-tv/mythtv-${PV}*[alsa?,cdda?,cdr?,ieee1394?,libass?,raw?,xml?,xvid]
	mytharchive? (
		${PYTHON_DEPS}
