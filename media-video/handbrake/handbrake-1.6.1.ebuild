...
LICENSE="GPL-2"
SLOT="0"
IUSE="fdk gstreamer gtk +libav-aac numa nvdec nvenc x265"
...
RDEPEND="
	...
	media-libs/zimg
	media-sound/lame
	media-video/ffmpeg[postproc,fdk?]
	sys-libs/zlib
	...
	nvdec? ( media-libs/nv-codec-headers )
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-1.6.1-dont-search-for-python.patch"
